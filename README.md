...
## Build History
* **v1.12.0 (2026.05.09)**
    * **플레이어 관련 스크립트를 하드코딩에서 ScriptableObject(SO)으로 적용(이동속도, 각 무기 데미지, 발사 시간 등)
    * **스테이지 진입 시 현재 스테이지 이름을 알려줄 텍스트 추가.**: Dictionary와 Coroutine을 활용하여 씬 등장 시 스테이지 타이틀 텍스트와 UI 연출 추가
* **v1.11.0 (2026.04.19)**
