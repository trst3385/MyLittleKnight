...
<details open>
<summary><b>v1.12.0 (2026.05.09) - 최신 주요 업데이트</b></summary>
<br/>

- **ScriptableObject 도입**: 플레이어 관련 스크립트를 하드코딩에서 SO로 전환 (이동속도, 무기 데미지, 발사 시간 등)
- **스테이징 연출**: Dictionary와 Coroutine을 활용한 스테이징 타이틀 텍스트 및 UI 연출 추가

</details>

<details>
<summary><b>v1.11.0 (2026.04.19) (클릭하여 펼치기)</b></summary>
<br/>
 
- **공격 시스템 자동화**: 활(Bow) 무기의 공격 방식을 수동에서 쿨타임 기반의 자동 공격으로 전환
- **조작 체계 최적화**: 액션성 강화를 위해 검(Sword) 공격 키를 Q에서 Space로 변경
- **상태 관리 예외 처리**: 자동 공격 중 수동 공격 시 발생하는 애니메이션 캔슬 및 상태 변수 고립(State Lock) 방지
- **플레이어 실루엣 애니메이션 동기화**: 실루엣 시스템 내 애니메이션 이벤트 수신기 누락 에러 해결

</details>

<details>
<summary><b>v1.10.0 (2026.04.08)</b></summary>
<br/>
...
<details>
<summary><b>v1.5.0 ~ 1.5.3</b></summary>
<br/>
