        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    //Vector2[] sourceUVs0 = cachedMeshInfoVertexData[materialIndex].uvs;
                    //Vector2[] destinationUVs0 = textInfo.meshInfo[materialIndex].uvs;
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    //textInfo.meshInfo[i].mesh.uv = textInfo.meshInfo[i].uvs;
